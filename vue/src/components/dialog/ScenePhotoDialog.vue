<template>
<div class="m-dialog-mask" style="z-index: 10000">
    <div class="m-dialog" style="max-width:500px;margin-top:10px">
      <div class="m-dialog-content" style="background-color: rgb(58,124,178);border-radius: 20px">
        ...
        <div class="m-dialog-header">
          <div class="u-head" style="color: #ffffff;font-size: 20px;text-align: center
;margin-top: 5px;margin-bottom: 5px">{{ goodsName }}</div>
        </div>
        <el-carousel trigger="click" height="350px" style="border-radius: 10px;margin: 10px">
          <el-carousel-item v-for="item in photos" :key="item" style="background-color: rgb(0,0,0,0)">

            <div style="display: flex">

              <img style="align-content: center;width: 100%;height: 100%" :src="item.src">
...
<!--        <img :src="phoSrc" style="max-width: 600px;max-height: 400px;overflow: hidden;-->
