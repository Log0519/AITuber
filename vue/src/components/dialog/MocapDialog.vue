  ...
  <div class="m-dialog-mask" >
    <div class="m-dialog" :style="`width: ${dialogWidth}; height: ${dialogHeight};`">
      <div class="m-dialog-content">
        ...
        <div class="m-dialog-header" style="display: flex">
          <div class="u-head">{{ title }}</div>
          <div>
          <el-input style="margin-left: 200px;width: 200px"></el-input>
            <el-button style="margin-left: 5px" type="primary" plain>搜索</el-button>
          </div>
        </div>
        <div class="m-dialog-body" :style="`height: calc(${dialogHeight} - 156px);`">
            <el-table :data="gridData">
              <el-table-column property="time" label="修改日期" width="130"></el-table-column>
              <el-table-column property="name" label="问题" width="200"></el-table-column>
                <el-table-column property="answer" label="回答" width="200"></el-table-column>
              <el-table-column property="deal" label="操作">
...
export default {
  ...
  data () {
    return {
      gridData: [
        {'name': "预计多久发售呢",'time':"2022-12-1 12:12",'answer':'12月份就会发售'},
        {'name': "这个商品打折吗",'time':"2022-12-1 12:14",'answer':'新品不打折哟'},
        {'name': "双十一活动吗",'time':"2022-12-1 12:46",'answer':'双十一活动暂时还没确定'},
        {'name': "商品有保险吗",'time':"2022-12-1 13:16",'answer':'有的'},
        {'name': "这个有其他颜色的吗",'time':"2022-12-1 13:17",'answer':'这个有红色和白色'},
        {'name': "七天包退换吗",'time':"2022-12-1 13:18",'answer':'是的'},
        {'name': "预计多久发售呢",'time':"2022-12-1 12:12",'answer':'12月份就会发售'},
        {'name': "这个商品打折吗",'time':"2022-12-1 12:14",'answer':'新品不打折哟'},
        {'name': "双十一活动吗",'time':"2022-12-1 12:46",'answer':'双十一活动暂时还没确定'},
        {'name': "商品有保险吗",'time':"2022-12-1 13:16",'answer':'有的'},
